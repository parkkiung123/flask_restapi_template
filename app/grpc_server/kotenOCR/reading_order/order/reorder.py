...
from app.grpc_server.kotenOCR.reading_order.utils.xml import ConstantNumberOfTags
from app.grpc_server.kotenOCR.reading_order.order.smooth_order import smooth_order
from app.grpc_server.kotenOCR.reading_order.order.warichu_block import GroupWarichu
